...
packages/executor/
  ...
  bin/
    disco-executor       # Executable binary
  test/
    ipc-server.test.ts  # Unit tests for IPC server
    executor.test.ts    # Unit tests for DiscoExecutor
...
```
[executor] Starting Disco Executor
[executor] User: disco (uid: 1001)
