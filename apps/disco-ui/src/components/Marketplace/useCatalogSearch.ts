 ...
 *
 * Filtering and ordering come from `@disco/core/mcp-catalog/query` rather than
...
import { filterCatalog } from '@disco/core/mcp-catalog/query';
import type { MCPCatalogCategory, MCPCatalogEntry, MCPCatalogSort } from '@disco/core/types';
import type { DiscoClient, FindResult } from '@disco-live/client';
