...
> User-facing reference: [`apps/disco-docs/pages/guide/branches.mdx`](../../apps/disco-docs/pages/guide/branches.mdx).
...
- A **Branch** is a first-class git working directory at `~/.disco/worktrees/<repo>/<name>`, on its own branch, with its own dev environment.
...
Service: `apps/disco-daemon/src/services/branches.ts`.
...
- Card on board: `apps/disco-ui/src/components/BranchCard/`
- Modal (5 tabs: Overview, Sessions, Environment, Schedule, Owners): `apps/disco-ui/src/components/BranchModal/`
