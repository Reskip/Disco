...
import type { DiffEnrichment } from '@disco-live/client';
...
export interface ToolRendererProps {
  ...
  /** Whether the renderer is displayed inside the compact activity timeline. */
  compact?: boolean;
}
...
export const TOOL_RENDERERS = new Map<string, ToolRenderer>([
  ...
  ['ViewImage', ViewImageRenderer as unknown as ToolRenderer],
]);
