 ...
 * the shared hasMinimumRole() from @disco/core. Eliminates scattered
 * role string comparisons and prop-drilling of currentUser.
 */

import type { UserRole } from '@disco-live/client';
import { hasMinimumRole, ROLES } from '@disco-live/client';
