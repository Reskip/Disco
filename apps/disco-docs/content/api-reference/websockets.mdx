...
description: Real-time WebSocket event documentation for disco. Socket.io event reference for sessions, tasks, messages, and multiplayer presence updates.
---
...
socket.on('connect', () => {
  console.log('Connected to Disco daemon');
});
```
