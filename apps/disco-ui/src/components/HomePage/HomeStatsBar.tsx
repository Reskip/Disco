...
import { discoStore, shallow, useDiscoStore, useStoreWithEqualityFn } from '../../store/discoStore';
...
export const HomeStatsBar: React.FC<{
  ...
  const teamSize = useDiscoStore((s) => s.userById.size);
  ...
  const weekTooltip =
    isMultiUser && currentUserId && activeThisWeek > 0
      ? t('teamWeekTooltip', { mine: myThisWeek, team: activeThisWeek })
      : undefined;
