...
import styles from './DiscoCloudLanding.module.css';
...
const ANNOUNCEMENT_HREF = '/blog/disco-cloud';

// The operational reality of self-hosting a multi-user Disco: the honest case
// for a managed offering, without disparaging the open product. Grounded in the
// Disco Cloud announcement post.
...
// What Disco Cloud manages. Every claim maps to shipped capability in the
// disco-cloud control plane (EKS + Karpenter, per-team workspaces & roles,
...
const capabilitySupport: Array<{ icon: LucideIcon; title: string; body: ReactNode }> = [
  ...
  },
  {
    ...
    body: 'Run multiple Disco workspaces under one account and segment them by team, project, or sensitivity. Each workspace is its own tenant, with a separate database and strict boundaries between them, so you can dial isolation up exactly where it matters.',
  },
  {
    icon: Activity,
...
const deployments: Array<{
...
}> = [
  {
    ...
    title: 'Disco Cloud (hosted)',
    body: 'A managed, single-tenant Disco instance on our infrastructure. Up in minutes, always on the latest secured release, hardened to sit safely on the public internet.',
    featured: true,
  },
  {
    badge: 'In your AWS',
    ...
    body: 'We deploy and operate Disco inside your own AWS account, so data and compute stay in your tenancy, with private network access to your VPC. Talk to us about fit.',
  },
  {
    badge: 'Enterprise',
...
export function DiscoCloudLanding() {
    ...
    <main ref={shellRef} id="nextra-skip-nav" className={styles.landingShell}>
      ...
      <section className={styles.hero}>
        {/* React Bits shader backdrop (see components/Lightfall) instead of
            product-demo video — tinted to Disco's brand palette. Hidden
        ...
        <div className={styles.heroInner} data-reveal>
          <p className={styles.heroBadge}>
            ...
            Disco Cloud · Private beta
          </p>
          <h1>
            Fully managed Disco for your <span className={styles.headingStrong}>whole team</span>
          </h1>
          <p className={styles.heroSub}>
            Disco is open, and yours to run. Disco Cloud is for teams who’d rather not. We operate a
            hardened, always-current Disco for you, with scaling, isolation, governance, and
      ...
      <section className={styles.section} data-reveal>
        ...
        <div className={styles.sectionHead}>
          ...
          <h2>
            You can run Disco yourself.
            <br />
            Most teams <span className={styles.headingStrong}>shouldn’t have to</span>.
          </h2>
          <p className={styles.lead}>
            Disco is source-available under BSL 1.1, and running it in production yourself is
        ...
        <p className={styles.pivot}>
          Disco Cloud is us doing that once,{' '}
                ...
                >
                  ...
                  >
                    ...
                    <img
                      ...
                      src={item.image}
                      alt={`Screenshot of ${item.title} in Disco`}
      ...
      <div className={styles.band}>
        <section className={styles.section} data-reveal>
          <div className={styles.sectionHead}>
            ...
            <p className={styles.lead}>
              When Disco becomes part of how your team ships, you need to see what’s happening in it,
      ...
      <section className={styles.section} data-reveal>
        <div className={styles.sectionHead}>
          ...
          <p className={styles.lead}>
            ...
            same Disco, in the topology your security team needs.
          </p>
        </div>
          ...
          <div className={styles.trustLayout}>
            <div className={styles.trustText}>
              <div className={styles.sectionHead}>
                ...
                <p className={styles.lead}>
                  Some of Disco’s capabilities are great inside a trusted network and risky on the
            ...
            <div className={styles.trustShotFrame}>
              ...
              <img
                ...
                alt="A security-review branch in Disco, with sub-sessions fanned out across RBAC, secrets management, execution isolation, dependency supply chain, and more"
                loading="lazy"
              />
            </div>
          </div>
        ...
        <div className={styles.operator}>
          <div>
            ...
            <h2>
              ...
              <Link
                href={`${PRESET_URL}${presetUtm('disco-cloud-operator')}`}
                target="_blank"
            ...
            <p>
              ...
              teams. Disco Cloud is operated with the same on-call rigor, by the people building
              Disco. You get hands-on onboarding, a direct line for feedback, and features
          ...
          <div className={styles.operatorStats}>
            <div className={styles.stat}>
              ...
              <span className={styles.statLabel}>
                The team that wrote Disco keeps it running, and they know which knobs matter.
              </span>
            </div>
            <div className={styles.stat}>
            ...
            <div className={styles.stat}>
              ...
              <span className={styles.statLabel}>
                We’re on-call for Disco, so your team stays on-call for your product.
              </span>
            </div>
            <div className={styles.stat}>
      ...
      <section className={`${styles.section} ${styles.finalCta}`} data-reveal>
        ...
        <div className={styles.ctaCard}>
          <h2>
            Bring your team to <span className={styles.headingAccent}>Disco Cloud</span>
          </h2>
          <p>
      ...
      <footer className={styles.footer} data-reveal>
        <div className={styles.footerInner}>
          <div className={styles.footerBrand}>
            ...
            <div>
              <strong>Disco Cloud</strong>
              <p>Fully managed Disco for teams.</p>
            </div>
          </div>
          <div className={styles.footerLinks}>
            ...
            <Link
              href={`${PRESET_URL}${presetUtm('disco-cloud-footer')}`}
              target="_blank"
              rel="noopener noreferrer"
              className={styles.footerLink}
            >
      ...
      <HubSpotFormModal
        ...
        title="Request an Disco Cloud invite"
