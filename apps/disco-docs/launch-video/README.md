...
The 40-second cinematic product tour for Disco — "Break out of the terminal" → the
...
| `composition/design.md`                                  | ✅            | Brand colors/fonts (mirrors disco.live)                                                           |
...
```bash
cd apps/disco-docs/launch-video
...
beat map in `assets/music/cues/disco-epic-40s.*` is keyed to this bed).
...
All screenshots come from the docs site (`apps/disco-docs/public/screenshots`,
...
Hook line and headlines are pulled **verbatim from disco.live**
