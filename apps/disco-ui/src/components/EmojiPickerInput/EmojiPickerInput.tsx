...
const DiscoEmojiPickerInner = lazy(() => import('./DiscoEmojiPickerInner'));
 ...
 * cdn.jsdelivr.net, blocked by Disco's default img-src CSP.
 */
export const DiscoEmojiPicker: React.FC<Pick<PickerProps, 'onEmojiClick'>> = ({ onEmojiClick }) => (
  <Suspense fallback={<EmojiPickerFallback />}>
    <DiscoEmojiPickerInner onEmojiClick={onEmojiClick} />
  </Suspense>
);
...
export const EmojiPickerInput: React.FC<EmojiPickerInputProps> = ({
  ...
  return (
    <Popover
      content={<DiscoEmojiPicker onEmojiClick={handleEmojiClick} />}
