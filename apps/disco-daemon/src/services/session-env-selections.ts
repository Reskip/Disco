 ...
 * (see `ensureSessionOwnerOrAdmin`). Access to another workspace is NOT
 * sufficient — session env selections expose the creator's private
 * credentials.
 */

import { SessionEnvSelectionRepository, type TenantScopeAwareDatabase } from '@disco/core/db';
import type { QueryParams, SessionEnvSelection, SessionID } from '@disco/core/types';
