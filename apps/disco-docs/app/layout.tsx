...
const hubspotMeetingOrigin = new URL(DISCO_CLOUD_DEMO_URL).origin;
    ...
    >
      ...
      <body>
        ...
        {/* GTM event on contact-form submission. HubSpot's forms-embed
            ...
            single site-wide listener covers every "Sign up for Disco Cloud"
