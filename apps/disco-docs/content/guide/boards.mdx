...
_An Disco board staged for an active team: live cursors, roomy workflow zones, branch cards, markdown planning notes, and agent-built dashboards sharing the same canvas._
...
**Like Figma did for design**, Disco brings spatial collaboration to AI coding:
