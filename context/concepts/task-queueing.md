...
- Admission/launch/drain: `apps/disco-daemon/src/register-routes.ts`
- Fleet recovery: `apps/disco-daemon/src/services/session-queue-worker.ts`
- Local coalescer: `apps/disco-daemon/src/utils/session-turn-lock.ts`
- Producer identities: `apps/disco-daemon/src/utils/durable-task-id.ts`
- Widget resolution fence: `apps/disco-daemon/src/widgets/resolution-store.ts`
