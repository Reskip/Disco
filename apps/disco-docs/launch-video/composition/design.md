# Design System — disco brag video

Brand source of truth. Mirrors disco.live exactly. Use these values; do not invent colors
or substitute fonts.
...
- **Display:** system sans / Inter, weight **800–900**, very tight tracking **-0.05em**.
  Mirrors disco.live's `Meet your AI teammates.` headline. Big and confident.
...
- Thin **teal constellation/network lines** connecting small dots, drifting slowly, low
  ...
  (seeded PRNG — no Math.random / Date.now). This is the disco.live parallax background.
