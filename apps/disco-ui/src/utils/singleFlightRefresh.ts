 ...
 *    socket client, the socket-reconnect fallback in useDiscoClient). Without
 ...
 *    reconnect fallback in useDiscoClient and the 401-retry hook on the
...
export const TOKENS_REFRESHED_EVENT = 'disco:tokens-refreshed';
 ...
 */
export const TOKENS_REFRESH_UNRECOVERABLE_EVENT = 'disco:tokens-refresh-unrecoverable';
 ...
 */
export async function refreshAndReauthenticate(client: DiscoClient): Promise<RefreshResult | null> {
