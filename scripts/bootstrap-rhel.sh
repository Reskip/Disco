...
# Installs dependencies needed to run Disco
#

set -e  # Exit on error

echo "🚀 Bootstrapping Disco on RHEL/CentOS/Fedora..."
...
echo ""
echo "Next steps:"
echo "  1. disco init        # Initialize Disco"
echo "  2. disco daemon start # Start the daemon"
echo "  3. disco open        # Open the UI"
echo ""
echo "For more info: https://disco.live/guide/getting-started"
