...
import type { MessageCreate, MessagePatch, Session, SessionUpdate } from '@disco/core/types';
...
export interface MessagesService {
  ...
  /** Remove transient status rows once the underlying condition has recovered. */
 ...
 * exported from `@disco/core/client`, which is a much larger surface.
 */
