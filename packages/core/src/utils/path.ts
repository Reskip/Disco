 ...
 *
 * @param dbUrl - Database URL (e.g., 'file:~/.disco/disco.db' or '~/.disco/disco.db')
 * @returns Expanded file path (e.g., '/Users/username/.disco/disco.db')
 *
 * @example
 * ```typescript
 * extractDbFilePath('file:~/.disco/disco.db') → '/Users/username/.disco/disco.db'
 * extractDbFilePath('~/.disco/disco.db') → '/Users/username/.disco/disco.db'
