...
- `disco_kb_namespaces_list`: list readable namespaces and effective permission.
- `disco_kb_namespace_put`: create/update when permitted.
- `disco_kb_put`, `disco_kb_edit`, `disco_kb_publish_from_worktree`: require namespace write.
- `disco_kb_search`: search all readable namespaces by default.

Add or extend tools for namespace permissions only if useful for agents/admins:

- `disco_kb_namespace_acl_get`
- `disco_kb_namespace_acl_set`
