    ...
    >
      <img
        ...
        style={{
          ...
          // The Codex raster's visible mark is fractionally left/up inside its
          // canvas. A sub-pixel optical correction keeps the ChatGPT knot
          // visually centred without altering any other provider artwork.
          transform: tool === 'codex' ? 'translate(0.85%, 0.75%)' : undefined,
        }}
      />
    </div>
  );
