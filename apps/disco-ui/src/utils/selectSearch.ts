import type { Group, User } from '@disco-live/client';
...
export const userSelectLabel = (user: Pick<User, 'username' | 'name'>): string => {
...
export const userSelectSearchText = (user: Pick<User, 'username' | 'name'>) =>
...
export const toUserSelectOption = (
  user: Pick<User, 'user_id' | 'username' | 'name'>
