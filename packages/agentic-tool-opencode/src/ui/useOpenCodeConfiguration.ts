import type { DiscoClient } from '@disco/core/client';
import type { OpenCodeProviderSettings } from '@disco/core/types';
...
const resources = new WeakMap<DiscoClient, Map<unknown, ResourceEntry>>();
...
function entriesFor(client: DiscoClient): Map<unknown, ResourceEntry> {
...
function entryFor(client: DiscoClient): ResourceEntry {
...
export function useOpenCodeConfiguration(input: { client?: DiscoClient | null; enabled: boolean }) {
