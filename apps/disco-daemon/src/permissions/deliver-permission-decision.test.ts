...
import type { BranchPermissionLevel, Message, SessionID, TaskID } from '@disco/core/types';
import { PermissionScope, PermissionStatus, ROLES } from '@disco/core/types';
...
describe('deliverPermissionDecision', () => {
  ...
  it('denies another user before delivering an execution decision', async () => {
