...
> For the marketing-grade pitch, voice, and tagline: read the **Messaging & Positioning** doc in the Disco team Knowledge base ([`marketing/messaging-and-positioning`](https://disco.sandbox.preset.zone/kb/disco-cloud-team/marketing/messaging-and-positioning.md)) — it is intentionally kept out of this repo. This file is for agents who need a quick mental model.

Disco has **five primitives**. Almost everything in the codebase is one of these or a relationship between them.

## 1. Branch — the unit of work

A **git branch** at `~/.disco/worktrees/<repo>/<name>`, on its own branch, with its own dev environment. Conventionally: 1 branch = 1 feature/bug = 1 PR.
...
User-facing reference: [`apps/disco-docs/pages/guide/boards.mdx`](../../apps/disco-docs/pages/guide/boards.mdx).
...
User-facing reference: [`apps/disco-docs/pages/guide/sessions.mdx`](../../apps/disco-docs/pages/guide/sessions.mdx).
