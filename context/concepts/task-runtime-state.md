...
| Queue admission and launch                             | `apps/disco-daemon/src/register-routes.ts`                                                      |
| Task service methods and projections                   | `apps/disco-daemon/src/services/tasks.ts`                                                       |
...
| Runtime discovery and recovery                         | `apps/disco-daemon/src/services/task-runtime-reconciler.ts`                                     |
| Termination claims and containment settlement          | `apps/disco-daemon/src/termination-coordinator.ts`, `apps/disco-daemon/src/executor-tracking.ts` |
| Startup orphan reconciliation                          | `apps/disco-daemon/src/startup.ts`                                                              |
...
- [#319](https://github.com/preset-io/disco/pull/319) separated the privileged
  daemon from SDK execution.
- [#1068](https://github.com/preset-io/disco/pull/1068) made tasks the queueable
  unit and the daemon the initial prompt writer.
- [#1302](https://github.com/preset-io/disco/pull/1302) added executor
  heartbeats.
- [#1444](https://github.com/preset-io/disco/pull/1444) made terminal state
  first-writer-wins and repaired session/task divergence.
- [#1888](https://github.com/preset-io/disco/pull/1888) separated dispatch
  intent from authenticated executor connection.
- [#1964](https://github.com/preset-io/disco/pull/1964) separated wrapper
  liveness from SDK progress and centralized containment.
- [#2004](https://github.com/preset-io/disco/pull/2004) made Stop socket-first
  with durable quiescence reporting.
- [#2057](https://github.com/preset-io/disco/pull/2057) aligned Claude
