import { resolveApiKey } from '@disco/core/config';
import type { SessionRepository, TaskRepository } from '@disco/core/db';
import type { HookContext, Message, Session, Task } from '@disco/core/types';
...
vi.mock('@disco/core/config', () => ({ resolveApiKey: vi.fn() }));
