...
**Component:** `apps/disco-ui/src/components/BranchListDrawer/BranchListDrawer.tsx`
**Date:** 2026-05-06
...
Reading `apps/disco-ui/src/components/Pill/Pill.tsx`:
...
`apps/disco-ui/src/utils/time.ts` exports:
...
Per prompt: sort must be **per-user**. Two users on the same Disco instance see
