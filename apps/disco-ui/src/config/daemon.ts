...
import { DAEMON } from '@disco-live/client';
...
interface WindowWithDiscoConfig extends Window {
  DISCO_DAEMON_URL?: string;
}
...
export function getDaemonUrl(): string {
  ...
  if (typeof window !== 'undefined') {
    const injectedUrl = (window as WindowWithDiscoConfig).DISCO_DAEMON_URL;
