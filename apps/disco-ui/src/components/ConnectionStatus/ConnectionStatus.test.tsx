 ...
 *      grace window in useDiscoClient that keeps `connected=true` while
 ...
 *      forever. That fix lives in useDiscoClient; we cover the navbar's
...
describe('ConnectionStatus', () => {
   ...
   *
   * useDiscoClient keeps `connected=true` for a 1.5s grace window after a
