import { redactMCPAuthSecrets } from '@disco/core/tools/mcp/auth-secrets';
import { redactMCPCustomHeaders } from '@disco/core/tools/mcp/http-headers';
import type { MCPServer, Params } from '@disco/core/types';
