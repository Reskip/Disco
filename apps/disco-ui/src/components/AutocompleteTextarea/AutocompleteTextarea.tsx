...
import type { DiscoClient, SessionID, User } from '@disco-live/client';
...
const getTriggerQuery = (
  ...
  // For @ mentions, require whitespace before trigger to avoid matching username addresses
  ...
  (
    ...
    const autocompleteOptions = useMemo(() => {
      ...
      if (triggerType === '@') {
        ...
        // muscle memory, then append users.
    ...
    const handleChange = useCallback(
      (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        if (atTrigger) {
          ...
          // Debounced file search. Request sequence refs ignore stale in-flight results.
    ...
    const handleKeyDown = useCallback(
      (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
        ...
        // IME confirmation also emits Enter. Let the browser finish composing
        // instead of selecting an autocomplete item or submitting the prompt.
        // keyCode 229 covers browsers that fire compositionend just before keydown.
          ...
          case 'Tab':
            if (isPopoverOpen) {
              ...
              if (highlightedIndex >= 0) {
                ...
                if (!('heading' in item)) {
                  handleSelect(
                    item as FileResult | UserResult | EmojiResult | SlashCommandResult
                  );
                }
    ...
    return (
      ...
      >
        ...
        <TextArea
          ...
          className="disco-textarea disco-textarea-with-highlights"
          style={{
            borderColor:
