 ...
 *
 * Maps Copilot SDK events to Disco's streaming callback interface.
 *
...
/**
 * Wire up Copilot session events to Disco's streaming callbacks
 *
 * @param session - Copilot SDK session with event emitter
 * @param streamingCallbacks - Disco streaming callbacks for real-time UI updates
 * @param messageId - Message ID for the current streaming message
 * @param sessionId - Disco session ID
 * @param taskId - Optional Disco task ID
