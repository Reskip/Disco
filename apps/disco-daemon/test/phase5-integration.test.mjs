...
console.log('   2. Start daemon: cd apps/disco-daemon && pnpm dev');
...
console.log('   Edit ~/.disco/config.yaml and set execution.use_executor: true');
console.log('');
console.log('2. Restart daemon (in watch mode):');
console.log('   cd apps/disco-daemon && pnpm dev');
console.log('');
