...
import { type Session, SessionStatus, type Task, TaskStatus } from '@disco/core/types';
...
function waitForSocketConnect(socketClient: DiscoClient): Promise<void> {
...
describe('executor acknowledgement failure convergence', () => {
  ...
  let client: DiscoClient | undefined;
