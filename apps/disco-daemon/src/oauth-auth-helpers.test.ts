...
import { assertTenantWritable, runWithTenantDatabaseScope } from '@disco/core/db';
...
// Mock only runWithTenantDatabaseScope; preserve all other @disco/core/db exports
