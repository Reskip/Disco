 ...
 */
export function configureResolvedConfigSlice(config: DeepReadonly<DiscoConfig>): void {
...
export function buildResolvedConfigSlice(config: DeepReadonly<DiscoConfig>): ResolvedConfigSlice {
