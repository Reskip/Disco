import type { DiscoExecutionSettings } from './types';
...
export type ResolvedSdkWatchdogConfig = Required<
  NonNullable<DiscoExecutionSettings['sdk_watchdog']>
>;
...
export function resolveDispatchConnectTimeoutMs(execution?: DiscoExecutionSettings): number {
