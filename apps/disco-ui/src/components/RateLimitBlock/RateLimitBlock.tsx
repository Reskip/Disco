...
import { shouldHidePersistedClaudeSdkEvent } from '@disco/core/client/claude-system-suppression';
...
export const RateLimitBlock: React.FC<RateLimitBlockProps> = ({ message, agentic_tool }) => {
  ...
  // keeps both sides honest. See @disco/core/client/claude-system-suppression.
