...
| Service ownership and request hooks                                                                                        | `TENANT_OWNED_SERVICE_PATHS` and `TENANT_IDENTITY_ONLY_SERVICE_PATHS` in `apps/disco-daemon/src/register-hooks.ts`                                                     |
| Request/deferred identity helpers                                                                                          | `apps/disco-daemon/src/utils/tenant-db-scope.ts`                                                                                                                       |
| Queued session work                                                                                                        | `apps/disco-daemon/src/utils/session-queue-tenant-scope.ts`                                                                                                            |
| MCP database work                                                                                                          | `apps/disco-daemon/src/mcp/tenant-scope.ts`                                                                                                                            |
| Tenant-aware realtime delivery                                                                                             | `apps/disco-daemon/src/utils/realtime-publish.ts`                                                                                                                      |
