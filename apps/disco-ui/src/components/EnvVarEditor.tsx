import { ENV_VAR_SCOPES, type EnvVarMetadata, type EnvVarScope } from '@disco-live/client';
 ...
 * `EnvVarMetadata` shape or the compact boolean form used by settings callers.
 */
...
const SCOPE_OPTIONS = ENV_VAR_SCOPES.map((s) => ({
  value: s,
  label: SCOPE_LABEL[s],
}));
