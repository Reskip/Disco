...
[#2174](https://github.com/preset-io/disco/pull/2174) merged on 2026-08-06. This
...
- `@disco/core/coordination` diagnostic identity and bounded delay helpers.
...
PostgreSQL tests are gated by both `DISCO_TEST_POSTGRES_URL` and
`DISCO_DB_DIALECT=postgresql`; a skipped run is not evidence of a pass and must
