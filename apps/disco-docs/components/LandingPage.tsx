...
const productPreviews = [
  ...
  },
  {
    ...
    body: 'Anything a user can do in Disco, an agent can do too: spawn peers, move work, schedule runs, and report back.',
...
// Logos mirror the in-app ToolIcon set (apps/disco-ui/src/assets/tools), copied
...
const busItems: Array<{
  ...
  {
    title: 'MCP-native',
    desc: 'Anything you can do, an agent can do too, over Disco’s own MCP server. Enablement that scales beyond headcount.',
    rippleSize: 20,
...
// demo video rendered by the demo-videos pipeline (apps/disco-docs/demo-videos);
...
// Meet the roster — real teammates from our own Disco instance (names and
...
// Real teammates from the Preset Disco instance — names, jobs, and the meta
...
const rosterMembers: Array<{
  ...
  },
  {
    icon: DoorOpen,
    name: 'Hodor!',
    role: 'Disco’s own PM — issues, roadmap, ritual notes',
    meta: 'lives in #disco · attends rituals',
    r: 200,
    a: -158,
  },
];
    ...
    <main ref={landingRef} id="nextra-skip-nav" className={styles.landingShell}>
      <div className={styles.heroBanner}>
        ...
        <div className={styles.heroVideo} aria-hidden="true">
          <video
            ...
            playsInline
            preload="auto"
            poster="/videos/disco-hero-poster.jpg"
          >
            <source src="/videos/disco-hero-540.mp4" type="video/mp4" media="(max-width: 720px)" />
            <source src="/videos/disco-hero-720.mp4" type="video/mp4" media="(max-width: 1280px)" />
            <source src="/videos/disco-hero.mp4" type="video/mp4" />
          </video>
        </div>
        <section className={styles.heroSection}>
          <div className={styles.heroCopy} data-reveal>
            ...
            <div className={styles.heroActions}>
              ...
              >
                {variant ? variant.ctaLabel : 'Sign up for Disco Cloud'}
              </button>
      ...
      <section className={styles.problemSection} data-reveal>
        ...
        <p className={styles.problemPivot}>
          Disco helps your team avoid this{' '}
      ...
      <section className={styles.workspaceSection} data-reveal>
        <div className={styles.workspaceCopy}>
          ...
          <p>
            One-off prompts don’t compound. In Disco, teammates have durable identities your team can
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        ...
                        src={preview.image}
                        alt={`Screenshot of ${preview.title} in Disco`}
              ...
              <div className={styles.busDesc}>
                ...
                {item.beta && (
                  <>
                    ...
                    >
                      Register for the Disco Cloud beta
                    </button>
                    .
                  </>
                )}
      ...
      <div className={styles.auroraBand}>
        ...
        <section className={styles.liveSection} data-reveal>
          ...
          <p className={styles.liveSub}>
            ...
            <br />
            <span className={styles.headingDim}>
              Disco puts your whole team on one live,{' '}
      ...
      <section className={styles.rosterSection} data-reveal>
        <div className={styles.rosterCopy}>
          ...
          <p className={styles.rosterBody}>
            These teammates are a few examples from our own Disco instance today. Each with a name, a
        ...
        <div className={styles.radarScope} ref={radarScopeRef}>
          ...
          <div className={styles.radarOrigin} aria-hidden="true">
            ...
            <span className={styles.radarOriginLabel}>DISCO</span>
          </div>
      ...
      <section className={styles.finalCta} data-reveal>
        <div className={styles.ctaCard}>
          ...
          <p>
            ...
            enterprise-ready scale. Disco Cloud is opening to teams now.
          </p>
          <div className={styles.heroActions}>
            <button
              type="button"
      ...
      <footer className={styles.landingFooter} data-reveal>
        <div className={styles.footerBrand}>
          ...
          <div>
            ...
            <Link href="/blog/making-of-disco" className={styles.footerEtymology}>
        ...
        <div className={styles.footerLinks}>
          ...
          <div>
            ...
            <Link href="/blog/disco-cloud">Disco Cloud</Link>
          </div>
          <div>
            <h3>Community</h3>
      ...
      <HubSpotFormModal
        ...
        title="Join the Disco Cloud private beta"
