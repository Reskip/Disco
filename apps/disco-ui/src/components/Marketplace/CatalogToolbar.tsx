...
import type { MCPCatalogCategory, MCPCatalogSort } from '@disco/core/types';
        ...
        <Row gutter={[token.paddingSM, token.paddingSM]} align="middle">
          ...
          <Col flex="none">
            <Space size={token.marginXS}>
              ...
              <Tooltip title="Hides servers Disco knows need an account. Unchecked endpoints stay — connecting is what checks them.">
