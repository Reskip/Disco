 ...
 * - 'disco': Message originated from Disco UI
 */
export type MessageSource = 'disco';
 ...
 */
export type LegacyMessageSource = 'cli-repl' | 'gateway';
...
export interface Message {
  ...
  metadata?: {
     ...
     * - 'disco': Message originated from Disco UI
     * - legacy values may remain on historical rows but are never accepted by
