 ...
 * `disco_widgets_request_env_vars`. Captures secret value(s) via password
...
import type { DiscoClient, EnvVarScope, Message, WidgetMessageMetadata } from '@disco-live/client';
import {
  CheckCircleOutlined,
  LockOutlined,
  MinusCircleOutlined,
