...
description: 'Keep AI context maintainable: bite‑sized md nuggets in a context/ folder, cross‑linked and treated like code. How it accelerated Disco and what’s next.'
...
Did this alone enable shipping most of Disco in under a month (after hours)? Not alone, but it removed a major bottleneck for both me and the agents.
...
- You want parallelism, with multiple agents working simultaneously.
...
If you use Disco, you’ll see this structure reflected across boards and the agent workflows. It keeps everyone (humans and AIs) on the same page without inflating prompts.

## Related

- Superset context discussion: https://github.com/apache/superset/issues/35820
- Disco announcement: /blog/announcement
- Working notes on building Disco: /blog/making-of-disco
