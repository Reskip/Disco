...
-- required_env_vars, disco_grants, disco_runtime), all of which are now driven
...
CREATE OR REPLACE FUNCTION __disco_try_jsonb(value text) RETURNS jsonb
...
ALTER TABLE "artifacts"
  ALTER COLUMN "files" TYPE jsonb USING __disco_try_jsonb("files");--> statement-breakpoint

ALTER TABLE "artifacts"
  ALTER COLUMN "dependencies" TYPE jsonb USING __disco_try_jsonb("dependencies");--> statement-breakpoint

ALTER TABLE "artifacts"
  ALTER COLUMN "build_errors" TYPE jsonb USING __disco_try_jsonb("build_errors");--> statement-breakpoint

DROP FUNCTION __disco_try_jsonb(text);
