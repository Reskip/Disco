...
const auxiliaryAdapters: Partial<Record<Tool, () => Promise<AgenticToolAuxiliaryAdapter>>> = {
  opencode: async () =>
    (await import('@disco/agentic-tool-opencode/runtime')).OPENCODE_AUXILIARY_ADAPTER,
};
    ...
    runner: async (params) => {
      try {
        ...
        if (
          ...
          throw new Error(
            'Gemini support is not installed on this Disco instance. ' +
              'See https://disco.live/guide/extended-install#agentic-tools',
            { cause: error }
          );
        }
        throw error;
    ...
    runner: async (params) => {
      try {
        ...
        if (
          ...
          throw new Error(
            'Cursor SDK support is not installed on this Disco instance. ' +
              'See https://disco.live/guide/extended-install#agentic-tools',
            { cause: error }
          );
        }
