...
<div class="app-shell">
  <header class="topbar">
    <div class="brand">
      ...
      <div>
        <div class="brand-name">Disco</div>
    ...
    <div class="grid">
      <section class="main-column">
        <div class="section-title">
          ...
          <div class="filters"><span>All boards</span><span>Mine</span><span>Active</span><span>Teammates</span></div>
        </div>
        <div class="board-grid">
          ...
          <article class="board-card">
            ...
            <p>No primary teammate · parallel prototypes and model comparisons.</p>
            <div class="stats"><span>9 branches</span><span>12 sessions</span></div>
            <div class="faces"><span>M</span></div>
          </article>
          <article class="board-card">
            <div class="board-header">
              <h3><span class="emoji">🤖</span> Teammates</h3>
            </div>
        ...
        <section class="card list-card">
          ...
          <div class="session-row">
            ...
            <div class="row-main">
              ...
              <span>last prompted by you · Teammates · yesterday</span>
            </div>
            <span class="status done">done</span>
          </div>
          <div class="session-row">
          ...
          <div class="session-row">
            <div class="tool gemini">G</div>
            <div class="row-main">
              <strong>Explore teammate assignment UX</strong>
              <span>last prompted by you · Teammates · Jun 8</span>
            </div>
            <span class="status done">done</span>
          </div>
        </section>
      ...
      <aside class="right-rail">
        <section class="card activity">
          <div class="section-title compact"><h2>Team activity</h2><button class="info" data-tip="Curated, not raw CRUD: branch created, teammate created/assigned/prompted, artifact published, and mentions. Later: unioned activity summary query with grouping.">i</button></div>
          ...
          <div class="activity-item"><span class="dot amber"></span><a href="#">Ops Bot</a> requested permission on <a href="#">Teammates</a></div>
        ...
        <section class="card knowledge">
          ...
          <div class="doc-row"><strong>Teammate memory plan</strong><span>explorations · May 28</span></div>
          ...
          <div class="doc-row"><strong>Teammate assignment UX</strong><span>pages/teammates · Jun 2</span></div>
