...
import type { MessageSource, Params, PermissionMode, Task } from '@disco/core/types';
 ...
 * always represent a Disco-authored request, regardless of any stale or
 * forged `messageSource` field on the wire.
 */
export function normalizeMessageSource(
  input: MessageSource | undefined,
  params: Params
): MessageSource | undefined {
  if (params.provider) return 'disco';
  return input === 'disco' ? input : undefined;
}
