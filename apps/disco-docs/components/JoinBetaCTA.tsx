...
interface JoinBetaCTAProps {
   ...
   * specific spot this instance renders (e.g. `blog-disco-cloud`), since this
 ...
 * inline-embedded (blog/disco-cloud) and anywhere a beta CTA should keep the
 * reader on the page. Reuses CloudInviteCTA's primary-pill styling.
 */
export function JoinBetaCTA({ label = 'Sign up for Disco Cloud', sourceCta }: JoinBetaCTAProps) {
