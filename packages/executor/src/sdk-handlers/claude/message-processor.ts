...
} from '@disco/core/client/claude-system-suppression';
import type {
  SDKAssistantMessage,
...
export type ProcessedEvent =
  ...
  | {
      ...
      contextUsage: import('@disco/core/sdk').SDKControlGetContextUsageResponse;
    }
  | {
      type: 'stopped';
    }
...
export class SDKMessageProcessor {
  ...
  private handleUser(msg: SDKUserMessage | SDKUserMessageReplay): ProcessedEvent[] {
    ...
    if (hasToolResult) {
      ...
      return []; // Unknown user message type
    }
  }
  ...
  private static readonly SUPPRESSED_MESSAGE_TYPES = new Set([
    ...
    'prompt_suggestion', // End-of-conversation suggestions, not relevant in Disco
  ]);
