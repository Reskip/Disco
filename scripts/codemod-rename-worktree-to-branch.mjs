 ...
 *
 * Usage:
 *   node scripts/codemod-rename-worktree-to-branch.mjs              # apply to apps/disco-ui/src
...
const rootDir = rootArgIdx >= 0 ? args[rootArgIdx + 1] : 'apps/disco-ui/src';
...
const MACHINE_MARKERS = [
  ...
  '/worktree/',
  'disco_worktrees_',
  'git worktree', // git CLI primitive — not Disco's "branch" concept
  'git worktrees',
