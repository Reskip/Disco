...
function resolveSha() {
  const envSha = process.env.DISCO_BUILD_SHA?.trim();
...
if (sha === null) {
  ...
  const builtAt = process.env.DISCO_BUILT_AT?.trim() || new Date().toISOString();
