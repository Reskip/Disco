...
const GLASS_HIGHLIGHT_ANIMATION = `
  @keyframes disco-glass-highlight-primary {
    0%, 100% { transform: translate(0, 0) scale(1); opacity: 0.8; }
    50% { transform: translate(-28px, -18px) scale(1.15); opacity: 1; }
  }
  @keyframes disco-glass-highlight-secondary {
    0%, 100% { transform: translate(0, 0) scale(1); opacity: 0.5; }
    50% { transform: translate(20px, 28px) scale(1.1); opacity: 0.8; }
  }
  .disco-glass-highlight-primary {
    animation: disco-glass-highlight-primary 9s ease-in-out infinite;
  }
  .disco-glass-highlight-secondary {
    animation: disco-glass-highlight-secondary 12s ease-in-out infinite;
  }
...
export function GlassPanelHighlights({
  ...
  return (
    ...
    >
      ...
      <div
        className={animated ? 'disco-glass-highlight-primary' : undefined}
      ...
      />
      <div
        className={animated ? 'disco-glass-highlight-secondary' : undefined}
