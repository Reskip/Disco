import { type Database, runWithTenantContext } from '@disco/core/db';
import type { User, UserID } from '@disco/core/types';
...
vi.mock('@disco/core/config', async () => {
  const actual = await vi.importActual<Record<string, unknown>>('@disco/core/config');
