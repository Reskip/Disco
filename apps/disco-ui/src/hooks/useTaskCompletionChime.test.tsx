...
import type { DiscoClient, AudioPreferences, Task, TaskID } from '@disco-live/client';
...
/**
 * Build a mock DiscoClient whose tasks service stores `on`/`removeListener`
...
function render(client: MockClient | null) {
  return renderHook(
    ({ c }: { c: MockClient | null }) =>
      useTaskCompletionChime((c as unknown as DiscoClient) ?? null, USER_ID, audioPrefs),
