 ...
 * tenant deletion.
 *
 * Multi-tenancy is a PostgreSQL-only feature in Disco (the SQLite schema is
 ...
 * `derived` cannot express that — it reads as "Disco computed it", which is
 ...
 * - `computed-from-public-service` — Disco computed it, from such a mirror alone.
 * - `computed-from-repo` — Disco computed it, from repository data alone.
