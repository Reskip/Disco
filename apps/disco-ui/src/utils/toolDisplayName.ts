 ...
 * - Claude Code: mcp__{server}__{tool}  (e.g., mcp__disco__disco_execute_tool)
 * - Codex:       {server}.{tool}        (e.g., disco.disco_execute_tool)
 *
 ...
 *
 * @example parseMcpToolName("mcp__disco__disco_execute_tool") → { server: "disco", tool: "disco_execute_tool" }
 * @example parseMcpToolName("disco.disco_execute_tool") → { server: "disco", tool: "disco_execute_tool" }
 ...
 * - mcp__disco__disco_execute_tool + input.tool_name="disco_files_publish"
 *   → "disco_files_publish"
 * - disco.disco_execute_tool + input.tool_name="disco_files_publish"
 *   → "disco_files_publish"
 * - mcp__disco__disco_search_tools + input.query="files"
 *   → "search_tools: files"
 *
 * When input is NOT available (real-time streaming events):
 * - mcp__disco__disco_execute_tool → "disco_execute_tool"
 * - disco.disco_execute_tool → "disco_execute_tool"
 *
