import { type DiscoConfig, resolveMultiTenancyConfig } from '@disco/core/config';
import {
...
import type { Params, SessionID, TenantContext, TenantID } from '@disco/core/types';
...
function staticTenantId(config: DiscoConfig): string | undefined {
