/**
 * Shared helpers for the `disco tenant …` portability commands (inspect, export,
...
import { getTenantDataRootAsync, loadConfig } from '@disco/core/config';
...
export const TENANT_PORTABILITY_ERROR_MARKER = 'disco.tenant-portability.error' as const;
