import { MCPServerRepository, type TenantScopeAwareDatabase } from '@disco/core/db';
import type { MCPPrompt, MCPResource, MCPServerID, MCPTool } from '@disco/core/types';
