 ...
 * call (file writes and image previews) are promoted.
 *
 ...
 * (i.e. you almost always want to see it without another click). In practice
 * that's file writes / edits, where the diff IS the content, and image views,
 * where the thumbnail is the useful result.
 *
