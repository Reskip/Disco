...
const ApiReferenceReact = dynamic(
  ...
  { ssr: false, loading: () => <p className="disco-api-reference-loading">Loading API schema…</p> }
);
...
export function ApiReference() {
  ...
  return (
    <div className="disco-api-reference-page">
      <div className="disco-api-reference">
        <ApiReferenceReact
          configuration={{
            url: '/openapi/disco.json',
            theme: 'default',
            layout: 'modern',
            darkMode,
