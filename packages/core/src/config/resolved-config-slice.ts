 ...
 *
 * Strict subset of {@link DiscoConfig} the daemon resolves once at spawn time
 * and embeds in the executor payload. Lives in @disco/core so both packages
 ...
 *
 * Letting the executor read `~/.disco/config.yaml` itself is broken under
