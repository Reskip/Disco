...
describe('disco_mcp_servers_list', () => {
...
describe('disco_mcp_servers_create/update/attach', () => {
  ...
  it('validates conditional fields before creating', async () => {
    ...
    const parsed = schemas.disco_mcp_servers_create?.safeParse({
      name: 'bad-http',
      transport: 'http',
      auth: { type: 'oauth' },
    });
    ...
    const updateParsed = schemas.disco_mcp_servers_update?.safeParse({
