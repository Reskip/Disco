...
import type { MCPCatalogCategory, MCPCatalogEntry } from '@disco/core/types';
...
import {
  getLastConnectSessionId,
  rememberConnectSessionId,
  useConnectTargets,
  ...
  const handleConnect = useCallback(
    async ({
      ...
      try {
        ...
        rememberConnectSessionId(sessionId);
    ...
    <Flex vertical gap={token.margin}>
      ...
      {showDisconnected && (
        <Alert
          type="warning"
          showIcon
          message="Not connected to the Disco daemon"
      ...
      <CatalogDetailDrawer
        ...
        defaultSessionId={getLastConnectSessionId()}
