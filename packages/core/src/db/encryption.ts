...
function getMasterSecret(): string {
  const secret = process.env.DISCO_MASTER_SECRET;

  if (!secret) {
    console.warn(
      '⚠️  DISCO_MASTER_SECRET not set - API keys will be stored in plaintext. ' +
 ...
 * @param secret - Master secret (from DISCO_MASTER_SECRET env var)
