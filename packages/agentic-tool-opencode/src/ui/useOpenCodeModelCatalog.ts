...
import type { OpenCodeModelCatalog } from '@disco/core/types';
...
const resources = new WeakMap<DiscoClient, Map<unknown, CatalogEntry>>();
...
function entriesFor(client: DiscoClient): Map<unknown, CatalogEntry> {
...
function entryFor(client: DiscoClient): CatalogEntry {
...
export function invalidateOpenCodeModelCatalog(client: DiscoClient): void {
