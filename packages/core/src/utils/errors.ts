/**
 * Error utilities for consistent error handling across Disco
 *
...
/**
 * Base class for all Disco errors
 */
 ...
 */
export class NotFoundError extends DiscoError {
 ...
 */
export class AlreadyExistsError extends DiscoError {
 ...
 */
export class ValidationError extends DiscoError {
  constructor(
    message: string,
 ...
 */
export class UnauthorizedError extends DiscoError {
