 ...
 * fallback baked into @disco/core/models/copilot.ts.
 *
 * Design notes:
 *
...
import { COPILOT_MODEL_METADATA, DEFAULT_COPILOT_MODEL } from '@disco/core/models';
import type { Params, UserID } from '@disco/core/types';
