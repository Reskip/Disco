...
async function loadCleanup(): Promise<
  typeof import('@disco/daemon/uploads-maintenance').cleanupExpiredUploads
> {
  if (!isInstalledPackage()) {
    return (await import('@disco/daemon/uploads-maintenance')).cleanupExpiredUploads;
  }
  ...
  return (
    ...
    )) as typeof import('@disco/daemon/uploads-maintenance')
