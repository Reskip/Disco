import type { DiscoClient, AuthCheckResult } from '@disco-live/client';
...
function makeClient(result: Promise<AuthCheckResult> | AuthCheckResult) {
  ...
  } as never as DiscoClient;
  return { client, create };
}

function renderPanel(client: DiscoClient, onOpenAgenticToolSettings = vi.fn()) {
  return render(
    <AntApp>
