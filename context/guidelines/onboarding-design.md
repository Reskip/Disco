...
([`OnboardingWizard.tsx`](../../apps/disco-ui/src/components/OnboardingWizard/OnboardingWizard.tsx),
personas in [`onboardingPersonas.ts`](../../apps/disco-ui/src/utils/onboardingPersonas.ts)).
...
- A hardcoded persona → recommendation map with no visible logic reads as opaque ("how does it
  know what's best for me?", [disco#1956](https://github.com/preset-io/disco/issues/1956)). Goal
...
The canonical source for user-facing voice is the Disco team Knowledge base doc
`marketing/messaging-and-positioning.md` ("Disco — Messaging & Positioning (v2 draft)"), which
